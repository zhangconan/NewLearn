package com.zkn.newlearn.arrays;

/**
 * Created by zkn on 2016/12/7.
 */
import java.util.Arrays;
import java.util.Comparator;

public class TimeSort<T> {
    /**
     ...
     */
    private TimeSort(T[] a, Comparator<? super T> c) {
        this.a = a;
        this.c = c;
    ...
    static <T> void sort(T[] a, int lo, int hi, Comparator<? super T> c) {
         ...
         */
        TimeSort<T> ts = new TimeSort<>(a, c); //新建TimSort对象，保存栈的状态
